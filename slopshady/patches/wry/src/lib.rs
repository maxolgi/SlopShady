...
struct WebViewAttributes<'a> {
  ...
  /// Whether to ignore TLS certificate errors (e.g. self-signed certs).
  ///
  /// ## Platform-specific
  ///
  /// - **Windows**: Uses WebView2 `ServerCertificateErrorDetected` to accept self-signed certs.
  /// - **Linux**: Use `WebContext::set_ignore_tls_errors()` instead.
  /// - **macOS / Android / iOS**: Unsupported.
...
impl<'a> WebViewBuilder<'a> {
  ...
  /// Ignore TLS certificate errors (e.g. self-signed certificates).
  ///
  /// ## Platform-specific
  ///
  /// - **Windows**: Accepts certificate errors via `ServerCertificateErrorDetected`.
  /// - **Linux**: Use `WebContext::set_ignore_tls_errors()` instead.
  /// - **macOS / Android / iOS**: No effect.
  pub fn with_ignore_tls_errors(mut self, ignore: bool) -> Self {
    self.attrs.ignore_tls_errors = ignore;
    self
  }
