...
impl WebContext {
  ...
  /// Ignore TLS certificate errors (for self-signed certs in development).
  ///
  /// **Platform-specific:** Only effective on Linux (WebKitGTK).
  #[cfg(target_os = "linux")]
  pub fn set_ignore_tls_errors(&self) {
    self.os.set_ignore_tls_errors();
  }
