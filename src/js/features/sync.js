...
export const Sync = {
    ...
    _applyFullState(data) {
        ...
        try {
            ...
            if (data.currentShaderId) state.currentShaderId = data.currentShaderId;
            ...
            // Server has no shader - use the hardcoded fallback in the textarea
            ...
            // Layer system state
            if (data.layers || data.backgroundLayer || data.master) {
            ...
            if (OSCUI && typeof OSCUI.applyState === 'function') {
    ...
    _applyUpdate(data) {
        ...
        try {
            ...
            if (data.currentShaderId !== undefined) state.currentShaderId = data.currentShaderId;
            if (data.modulationRoutes) {
                state.modulationRoutes = data.modulationRoutes;
            }
            if (data.layerModulationMatrices !== undefined) {
