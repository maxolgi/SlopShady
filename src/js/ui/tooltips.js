...
const T = {
    ...
    SETTINGS_AUDIO_SOURCE: 'Audio source feeding u_audioWaveform/u_audioSpectrum: Webamp player, microphone (Visual Brain), or screen-capture tab audio',
    ...
    SETTINGS_LLM_CONN: 'LLM connection mode — Direct: browser talks to the API (needs CORS); relay: requests proxy through this server',
    SETTINGS_THINKING: 'Reasoning effort (reasoning_effort) — lower levels think less and answer faster. Default omits the parameter; only some providers (GLM, OpenAI o-series) support it',
    SETTINGS_TEXT_MINUS: 'Decrease response text size',
    SETTINGS_TEXT_PLUS: 'Increase response text size',
...
const OSC_ADDR = {
    ...
    VB_COLOR_W: ' · OSC /mix/brain/colorwt',
    ...
    FB_AMOUNT: ' · OSC /mix/fb/amt',
    FB_DECAY: ' · OSC /mix/fb/dcy',
    FB_ZOOM: ' · OSC /mix/fb/zm',
    FB_ROTATE: ' · OSC /mix/fb/rot',
    FB_OFFSET_X: ' · OSC /mix/fb/ox',
    FB_OFFSET_Y: ' · OSC /mix/fb/oy',
    FB_SATURATION: ' · OSC /mix/fb/sat',
    FB_BRIGHTNESS: ' · OSC /mix/fb/brt',
    // Per-layer
    LAYER_TYPE: ' · OSC /mix/{n}/input',
    LAYER_SHADER: ' · OSC /mix/{n}/preset',
    LAYER_BLEND: ' · OSC /mix/{n}/blend',
    LAYER_SOLO: ' · OSC /mix/{n}/solo',
    LAYER_SHOW: ' · OSC /mix/{n}/hide',
    LAYER_VOLUME: ' · OSC /mix/{n}/volume',
    LAYER_AUDIO_MUTE: ' · OSC /mix/{n}/mute',
    MIX_BRAIN_TOGGLE: ' · OSC /mix/{n}/brain',
    LAYER_OPACITY: ' · OSC /mix/{n}/opacity',
    LAYER_BRIGHTNESS: ' · OSC /mix/{n}/brt',
    LAYER_SPEED: ' · OSC /mix/{n}/spd',
    LAYER_POS_X: ' · OSC /mix/{n}/px',
    LAYER_POS_Y: ' · OSC /mix/{n}/py',
    LAYER_SCALE: ' · OSC /mix/{n}/scl',
    LAYER_AMOUNT: ' · OSC /mix/{n}/amt',
    LAYER_ROTATION: ' · OSC /mix/{n}/rot',
    LAYER_STRETCH: ' · OSC /mix/{n}/str',
    LAYER_RADIUS: ' · OSC /mix/{n}/rad',
    LAYER_MASK_X: ' · OSC /mix/{n}/mx',
    LAYER_MASK_Y: ' · OSC /mix/{n}/my',
    LAYER_SOFTNESS: ' · OSC /mix/{n}/sft',
    // Per-layer feedback
    LAYER_FB_ENABLED: ' · OSC /mix/{n}/fb',
    LAYER_FB_BLEND: ' · OSC /mix/{n}/fb/blend',
    LAYER_FB_AMOUNT: ' · OSC /mix/{n}/fb/amt',
    LAYER_FB_DECAY: ' · OSC /mix/{n}/fb/dcy',
    LAYER_FB_ZOOM: ' · OSC /mix/{n}/fb/zm',
    LAYER_FB_ROTATE: ' · OSC /mix/{n}/fb/rot',
    LAYER_FB_OX: ' · OSC /mix/{n}/fb/ox',
    LAYER_FB_OY: ' · OSC /mix/{n}/fb/oy',
...
const STATIC_MAP = [
    ...
    ['#audio-source-dropdown', 'SETTINGS_AUDIO_SOURCE'],
    ...
    ['#llmConnection-dropdown .dropdown__selected', 'SETTINGS_LLM_CONN'],
    ['#llmThinking-dropdown .dropdown__selected', 'SETTINGS_THINKING'],
    ['#responseTextMinus', 'SETTINGS_TEXT_MINUS'],
    ['#responseTextPlus', 'SETTINGS_TEXT_PLUS'],
