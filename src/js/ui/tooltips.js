...
const T = {
    ...
    TAB_RECORDER: 'Video recording controls · Ctrl+Shift+R',
    ...
    MIX_SCREEN_DEVICE: 'Select which monitor to capture',
    ...
    REC_START: 'Start recording canvas as video · Ctrl+Shift+R',
    REC_STOP: 'Stop recording and trigger download',
    REC_FORMAT: 'Video codec: VP9 (better quality) or VP8 (wider support)',
    REC_RESOLUTION: 'Output video resolution',
    REC_FPS: 'Recording frame rate',
    REC_BITRATE: 'Encoding bitrate (1-100 Mbps) — higher = better quality',
    ...
    STREAM_INPUT_START: 'Start WebSRT connection for the selected input. Connection also opens automatically when a layer routes here; Stop only closes if no layer is using it.',
    STREAM_INPUT_STOP: 'Stop WebSRT connection for the selected input. If a layer is still routed here, the connection is kept alive and a status note appears briefly.',
    ...
    SETTINGS_RESOLUTION: 'Canvas resolution scale factor',
...
const STATIC_MAP = [
    ...
    ['[data-module="recorder"]', 'TAB_RECORDER'],
    ...
    ['#screen-device-dropdown', 'MIX_SCREEN_DEVICE'],
    ...
    ['#startRecording', 'REC_START'],
    ['#stopRecording', 'REC_STOP'],
    ['#rec-format-dropdown .dropdown__selected', 'REC_FORMAT'],
    ['#rec-resolution-dropdown .dropdown__selected', 'REC_RESOLUTION'],
    ['#rec-fps-dropdown .dropdown__selected', 'REC_FPS'],
    ['#rec-bitrate-slider', 'REC_BITRATE'],
    ...
    ['#stream-input-start', 'STREAM_INPUT_START'],
    ['#stream-input-stop', 'STREAM_INPUT_STOP'],
